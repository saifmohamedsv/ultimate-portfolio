...
export const BackgroundBeamsWithCollision = ({
  ...
  const isInView = useInView(parentRef, { once: false, margin: "200px" });
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "h-96 md:h-160 bg-linear-to-b from-white to-neutral-10 dark:from-neutral-950 dark:to-neutral-950 relative flex items-center w-full justify-center overflow-hidden",
        // h-screen if you want bigger
        className
      )}
    >
      {isInView && beams.map((beam) => (
        <CollisionMechanism
